...
class TableComponent: Component {
    ...
    private static func calculateTableHeight(columns: [String], rows: [[String]], tableWidth: CGFloat) -> CGFloat {
        ...
        let headerFontWeight: UIFont.Weight = config.headerFontWeight.lowercased() == "bold" ? .bold : .semibold
        ...
        let cellFontWeight: UIFont.Weight = config.bodyFontWeight.lowercased() == "bold" ? .bold : .regular
