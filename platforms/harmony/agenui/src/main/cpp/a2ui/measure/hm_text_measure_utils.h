...
public:
    ...
    // Note: CAPI widget parameter input units are vp; separate conversion is needed when setting attributes
                    ...
                    for (auto &attr : it._attributes) {
                        ...
                        if (first == "color" && !second.empty()) {
                            ...
                            if ("bold" == second) {
                                ...
                                sub_span.style.fontWeight = NODE_PROPERTY_FONT_LIGHT;
                            }
                        }
                    }
                } break;
