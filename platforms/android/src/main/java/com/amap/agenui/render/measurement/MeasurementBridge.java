...
public final class MeasurementBridge {
    ...
    public static MeasureResult directMeasure(String type,
        ...
        if (context == null || type == null || paramJson == null) {
            ...
            Log.w(TAG, "directMeasure skipped: context/type/paramJson invalid, result=" + result);
            return result;
        }

        Log.w(TAG, "directMeasure start: type=" + type
                + ", paramJson=" + paramJson
                + ", maxWidth=" + maxWidth
                + ", widthMode=" + widthMode
                + ", maxHeight=" + maxHeight
        ...
        Log.w(TAG, "directMeasure result: type=" + type + ", result=" + result);
        return result;
    }
}
