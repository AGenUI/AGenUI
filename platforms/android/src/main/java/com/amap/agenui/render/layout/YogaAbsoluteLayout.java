    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            if (rawParams instanceof YogaLayoutParams) {
                ...
                child.measure(
                        MeasureSpec.makeMeasureSpec(Math.max(0, params.yogaWidth), MeasureSpec.EXACTLY),
                        MeasureSpec.makeMeasureSpec(Math.max(0, params.yogaHeight), MeasureSpec.EXACTLY));
                contentWidth = Math.max(contentWidth, params.yogaX + params.yogaWidth + getPaddingRight());
                contentHeight = Math.max(contentHeight, params.yogaY + params.yogaHeight + getPaddingBottom());
            } else {
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            if (rawParams instanceof YogaLayoutParams) {
                ...
                child.layout(
                        ...
                        params.yogaY + params.yogaHeight);
            } else {
