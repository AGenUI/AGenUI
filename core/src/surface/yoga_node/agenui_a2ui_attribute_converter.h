...
namespace A2UIPropertyNames {
    ...
    static const char* kDirection = "direction";       // List layout direction
    static const char* kWeight = "weight";             // Relative weight in Row/Column (like flex-grow)

    // Table specific properties
    static const char* kColumns = "columns";           // Table column definition array (count = columns.size())
    static const char* kRows = "rows";                 // Table data row array (count = rows.size())
    static const char* kAxis = "axis";                 // Divider horizontal or vertical
    static const char* kOptions = "options";           // ChoicePicker option array
