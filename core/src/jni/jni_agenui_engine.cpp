...
static void jni_submitUserInput(JNIEnv* env, jclass clazz, jint instanceId, jstring jContent) {
    if (jContent == nullptr) {
    ...
    AGENUI_LOG("[JNI] submitUserInput: instanceId=%d, content=%s", instanceId, inputContent.c_str());
